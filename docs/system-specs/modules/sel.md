...
| Dashboard API | All POST/PUT/DELETE operations via middleware, plus allowed and denied project-skill trust, app-slot authorization, and strict session-monitor read decisions | `dashboard/server.py`, `dashboard/handlers/prompts.py`, `dashboard/handlers/autonudge.py` |
