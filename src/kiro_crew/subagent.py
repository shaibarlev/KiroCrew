...
class SubagentManager:
    ...
    async def _shadow_submit_accepted_run(self, info: SubagentInfo) -> bool:
        ...
        """
        try:
            return await self._shadow_submit_accepted_run_unchecked(info)
        except asyncio.TimeoutError:
    ...
    async def _await_retained_shadow_submit(self, info: SubagentInfo) -> None:
        ...
        submit_task = asyncio.create_task(self._shadow_submit_accepted_run(info))
    ...
    async def _shadow_submit_accepted_run_unchecked(self, info: SubagentInfo) -> bool:
