        ...
        async with self._lock:
            ...
            if existing is not None:
                ...
                if (
                    ...
                    and existing.task == request.task
                    and existing.conversation_key == request.conversation_key
                    ...
                    and existing.created_at == request.created_at
                    and existing.terminal_at == request.terminal_at
                    and event is not None
                    and event.destination == request.destination
